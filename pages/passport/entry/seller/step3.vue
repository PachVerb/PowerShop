  ...
  data() {
    return {
      ...
      rules: {
        ...
        storeLogo: [{ required: false, message: "请上传店铺logo" }],
        storeDesc: [{ required: false, message: "请填写店铺简介" }],
        storeCenter: [{ required: false, message: "请选择店铺位置" }],
        storeAddressIdPath: [{ required: false, message: "请选择店铺位置" }],
